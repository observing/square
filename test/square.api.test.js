...
describe('[square] API', function () {
  ...
  describe('.plugins', function () {
    it('should return a Array of available plugins', function () {
    ...
    it('should contain name, filename, path and description', function () {
      Square.plugins().forEach(function (plugin) {
        ...
        expect(plugin.filename).to.exist;
  ...
  describe('#forEach', function () {
    it('should fetch the correct plugins based on type');
    ...
    it('should iterate over all plugins in the correct order', function (done) {
      ...
      var one = require(fixtures + '/plugin.fixture');
      one.prototype['unique-id'] = '12';

      // IMPORTANT kill the require cache here, so we have separate modules and
      // don't override the prototype for this "instance"
