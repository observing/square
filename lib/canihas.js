...
var npm = require('npm')
  ...
  , has = require('../package.json').canihas;

/**
 * Attach the list of packages to the exports based on the `canihas` field in
...
Object.keys(has).forEach(function (name) {
  Object.defineProperty(exports, name, {
    get: function findPackage () {
      return exports.canihas.bind(exports, name, has[name]);
    }
  });
});
...
exports.canihas = function canihas (packages, version, fn) {
