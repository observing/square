...
module.exports = function commandline(argv) {
  ...
  cli
    ...
    .option('-d, --distribute <distribution>', 'only build these distributions', list, ['min', 'dev'])
  ...
  async.reduce(cli.args, {}, function (memo, bundle, callback) {
    ...
    square.package.configuration.storage = cli.storage;
    square.package.configuration.platform = cli.platform;
    square.package.configuration.distribute = cli.distribute;
