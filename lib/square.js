...
Square.prototype.parse = function parse (data) {
  ...
  */
  ...
  this.package.configuration = merge(this.package.configuration || {}, this.config);
...
Square.prototype.tag = function tag (content, type) {
...
Square.prototype.write = function write (content, type, extension) {
  ...
  var configuration = this.package.configuration
    , output = configuration.output[extension].replace(/~/g, process.env.HOME)
