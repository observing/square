...
Square.prototype.parse = function parse (data) {
  ...
  */
  ...
  if (configuration.license) {
    location = path.join(this.package.path + configuration.license);
...
Square.prototype.merge = function merge () {
  ...
  function insert (match, commenttype, statement, file) {
    var location = path.join(self.package.base, file);
...
Square.prototype.license = function copyright (content, type, extenstion) {
  var configuration = this.package.configuration
