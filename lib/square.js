...
Square.prototype.parse = function parse(data, parseOnly) {
  ...
  if ('import' in struct.configuration) {
    ...
    if (typeof extend !== 'object') extend = { 1: extend };

    Object.keys(extend).forEach(function loopImports(key) {
      _.extend(struct.configuration, extend[key].configuration);
      _.extend(struct.bundle, extend[key].bundle);
    });
  }
