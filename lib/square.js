...
Square.prototype.parse = function parse(data, parseOnly) {
  ...
  if ('plugins' in struct.configuration) config.plugins.forEach(this.plugin.bind(this));

  // Add storage engines from configuration.
  if ('storage' in struct.configuration) config.storage.forEach(this.storage.bind(this));
