...
var Ion = module.exports = function Ion () {
  // utility functions
...
Ion.prototype.use = function use (layer) {
...
Ion.prototype.configure = function configure (evn, fn) {
  var envs = 'all'
...
Ion.prototype.bundle = function bundle () {
...
Ion.prototype.parse = function parse (data) {
  /**
