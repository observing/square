...
Watcher.prototype.watch = function watch(Notify, findit) {
  var self = this
    ...
    , notifier, finder, limited, adaptable;
  ...
  adaptable = new Notify(this.config);
  adaptable.on('change', _.debounce(this.rebuild.bind(this)), 100);
  adaptable.on('error', this.refresher.bind(this));
